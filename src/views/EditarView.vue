          ...
          <div class="principal">
            <b-row>
              ...
              <b-col cols="12" sm="12" md="12" lg="12" xl="6">
                <div class="cad">
                  <h1 class="cadastre">Editar Cadastro</h1>
                </div>
                <div class="coluna-dois">
                  ...
                  <b-row>
                    <b-col class="coluna" sm="12" md="6" lg="12" xl="6">
                      <label class="label__text" for="firstName">
                        Município
                      </label>
                      <b-form-input
                        class="input-text"
                ...
                <b-row>
                  ...
                  <router-link to="/">
                      ...
                      -->
                      <b-row>
                        <b-col cols="6" sm="7" md="7" lg="7" xl="7">
                          <button @click="deleteUser()" class="remover">
                            Remover Usuário
                          </button>
                        </b-col>
                        <b-col cols="3" sm="2" md="2" lg="2" xl="2">
                          <button @click="updateUsers()" class="editar">
                            Editar dados
                          </button>
                        </b-col>
                      </b-row>
...
export default {
  ...
  methods: {
    ...
    deleteUser() {
      if (window.confirm("Você realmente quer deletar a conta?")) {
        firebaseDb
          .collection("users")
          .doc(this.id)
          .delete()
          .then(() => {
            this.$swal("Sucesso", "Usuário Deletado!", "success");
            localStorage.clear();
            this.$router.push("/");
          })
          .catch((error) => {
